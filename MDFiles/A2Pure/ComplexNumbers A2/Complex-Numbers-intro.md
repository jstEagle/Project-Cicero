The ancient Greeks thought $x+10=9$ had no solution because no one had thought of negative numbers. **All real numbers are complex numbers but only some complex numbers are real**
### $$i = \sqrt{-1}$$
### $$i^2 = -1$$
### $$i * i = -1$$
---
